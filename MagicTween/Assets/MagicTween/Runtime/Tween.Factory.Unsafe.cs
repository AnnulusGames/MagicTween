...
namespace MagicTween
{
    partial struct Tween
    {
            ...
            where TObject : class
        {
            ...
            return TweenFactory.CreateToTweenUnsafe<TObject, float, NoOptions, FloatTweenPlugin>(target, getter, setter, endValue, duration);
        }
        ...
        {
            Assert.IsNotNull(target);
            return TweenFactory.CreateToTweenUnsafe<TObject, float2, NoOptions, Float2TweenPlugin>(target, getter, setter, endValue, duration);
        }
        ...
        {
            Assert.IsNotNull(target);
            return TweenFactory.CreateToTweenUnsafe<TObject, float3, NoOptions, Float3TweenPlugin>(target, getter, setter, endValue, duration);
        }
        ...
        {
            Assert.IsNotNull(target);
            return TweenFactory.CreateToTweenUnsafe<TObject, float4, NoOptions, Float4TweenPlugin>(target, getter, setter, endValue, duration);
        }
        ...
        {
            Assert.IsNotNull(target);
            return TweenFactory.CreateToTweenUnsafe<TObject, double, NoOptions, DoubleTweenPlugin>(target, getter, setter, endValue, duration);
        }
        ...
        {
            Assert.IsNotNull(target);
            return TweenFactory.CreateToTweenUnsafe<TObject, double2, NoOptions, Double2TweenPlugin>(target, getter, setter, endValue, duration);
        }
        ...
        {
            Assert.IsNotNull(target);
            return TweenFactory.CreateToTweenUnsafe<TObject, double3, NoOptions, Double3TweenPlugin>(target, getter, setter, endValue, duration);
        }
        ...
        {
            Assert.IsNotNull(target);
            return TweenFactory.CreateToTweenUnsafe<TObject, double4, NoOptions, Double4TweenPlugin>(target, getter, setter, endValue, duration);
        }
        ...
        {
            Assert.IsNotNull(target);
            return TweenFactory.CreateToTweenUnsafe<TObject, int, IntegerTweenOptions, IntTweenPlugin>(target, getter, setter, endValue, duration);
        }
        ...
        {
            Assert.IsNotNull(target);
            return TweenFactory.CreateToTweenUnsafe<TObject, int2, IntegerTweenOptions, Int2TweenPlugin>(target, getter, setter, endValue, duration);
        }
        ...
        {
            Assert.IsNotNull(target);
            return TweenFactory.CreateToTweenUnsafe<TObject, int3, IntegerTweenOptions, Int3TweenPlugin>(target, getter, setter, endValue, duration);
        }
        ...
        {
            Assert.IsNotNull(target);
            return TweenFactory.CreateToTweenUnsafe<TObject, int4, IntegerTweenOptions, Int4TweenPlugin>(target, getter, setter, endValue, duration);
        }
        ...
        {
            Assert.IsNotNull(target);
            return TweenFactory.CreateToTweenUnsafe<TObject, long, IntegerTweenOptions, LongTweenPlugin>(target, getter, setter, endValue, duration);
        }
        ...
        {
            Assert.IsNotNull(target);
            return TweenFactory.CreateToTweenUnsafe<TObject, quaternion, NoOptions, QuaternionTweenPlugin>(target, getter, setter, endValue, duration);
        }
        ...
        {
            Assert.IsNotNull(target);
            return TweenFactory.CreateFromToTweenUnsafe<TObject, float, NoOptions, FloatTweenPlugin>(target, startValue, endValue, duration, setter);
        }
        ...
        {
            Assert.IsNotNull(target);
            return TweenFactory.CreateFromToTweenUnsafe<TObject, float2, NoOptions, Float2TweenPlugin>(target, startValue, endValue, duration, setter);
        }
        ...
        {
            Assert.IsNotNull(target);
            return TweenFactory.CreateFromToTweenUnsafe<TObject, float3, NoOptions, Float3TweenPlugin>(target, startValue, endValue, duration, setter);
        }
        ...
        {
            Assert.IsNotNull(target);
            return TweenFactory.CreateFromToTweenUnsafe<TObject, float4, NoOptions, Float4TweenPlugin>(target, startValue, endValue, duration, setter);
        }
        ...
        {
            Assert.IsNotNull(target);
            return TweenFactory.CreateFromToTweenUnsafe<TObject, double, NoOptions, DoubleTweenPlugin>(target, startValue, endValue, duration, setter);
        }
        ...
        {
            Assert.IsNotNull(target);
            return TweenFactory.CreateFromToTweenUnsafe<TObject, double2, NoOptions, Double2TweenPlugin>(target, startValue, endValue, duration, setter);
        }
        ...
        {
            Assert.IsNotNull(target);
            return TweenFactory.CreateFromToTweenUnsafe<TObject, double3, NoOptions, Double3TweenPlugin>(target, startValue, endValue, duration, setter);
        }
        ...
        {
            Assert.IsNotNull(target);
            return TweenFactory.CreateFromToTweenUnsafe<TObject, double4, NoOptions, Double4TweenPlugin>(target, startValue, endValue, duration, setter);
        }
        ...
        {
            Assert.IsNotNull(target);
            return TweenFactory.CreateFromToTweenUnsafe<TObject, int, IntegerTweenOptions, IntTweenPlugin>(target, startValue, endValue, duration, setter);
        }
        ...
        {
            Assert.IsNotNull(target);
            return TweenFactory.CreateFromToTweenUnsafe<TObject, int2, IntegerTweenOptions, Int2TweenPlugin>(target, startValue, endValue, duration, setter);
        }
        ...
        {
            Assert.IsNotNull(target);
            return TweenFactory.CreateFromToTweenUnsafe<TObject, int3, IntegerTweenOptions, Int3TweenPlugin>(target, startValue, endValue, duration, setter);
        }
        ...
        {
            Assert.IsNotNull(target);
            return TweenFactory.CreateFromToTweenUnsafe<TObject, int4, IntegerTweenOptions, Int4TweenPlugin>(target, startValue, endValue, duration, setter);
        }
        ...
        {
            Assert.IsNotNull(target);
            return TweenFactory.CreateFromToTweenUnsafe<TObject, quaternion, NoOptions, QuaternionTweenPlugin>(target, startValue, endValue, duration, setter);
        }
        ...
        public static Tween<float, PunchTweenOptions> Punch<TObject>(TObject target, TweenGetter<TObject, float> getter, TweenSetter<TObject, float> setter, in float strength, float duration)
            where TObject : class
        {
            return TweenFactory.CreateUnsafePunchTween<TObject, float, PunchTweenPlugin>(target, getter, setter, strength, duration);
        }
        ...
        public static Tween<float2, PunchTweenOptions> Punch<TObject>(TObject target, TweenGetter<TObject, float2> getter, TweenSetter<TObject, float2> setter, in float2 strength, float duration)
            where TObject : class
        {
            return TweenFactory.CreateUnsafePunchTween<TObject, float2, Punch2TweenPlugin>(target, getter, setter, strength, duration);
        }
        ...
        public static Tween<float3, PunchTweenOptions> Punch<TObject>(TObject target, TweenGetter<TObject, float3> getter, TweenSetter<TObject, float3> setter, in float3 strength, float duration)
            where TObject : class
        {
            return TweenFactory.CreateUnsafePunchTween<TObject, float3, Punch3TweenPlugin>(target, getter, setter, strength, duration);
        }
        ...
        public static Tween<float, ShakeTweenOptions> Shake<TObject>(TObject target, TweenGetter<TObject, float> getter, TweenSetter<TObject, float> setter, in float strength, float duration)
            where TObject : class
        {
            return TweenFactory.CreateUnsafeShakeTween<TObject, float, ShakeTweenPlugin>(target, getter, setter, strength, duration);
        }
        ...
        public static Tween<float2, ShakeTweenOptions> Shake<TObject>(TObject target, TweenGetter<TObject, float2> getter, TweenSetter<TObject, float2> setter, in float2 strength, float duration)
            where TObject : class
        {
            return TweenFactory.CreateUnsafeShakeTween<TObject, float2, Shake2TweenPlugin>(target, getter, setter, strength, duration);
        }
        ...
        public static Tween<float3, ShakeTweenOptions> Shake<TObject>(TObject target, TweenGetter<TObject, float3> getter, TweenSetter<TObject, float3> setter, in float3 strength, float duration)
            where TObject : class
        {
            return TweenFactory.CreateUnsafeShakeTween<TObject, float3, Shake3TweenPlugin>(target, getter, setter, strength, duration);
        }
    }
}