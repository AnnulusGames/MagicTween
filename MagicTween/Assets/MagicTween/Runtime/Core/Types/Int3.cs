...
[assembly: RegisterGenericComponentType(typeof(TweenPropertyAccessorUnsafe<int3>))]
...
namespace MagicTween.Core
{
    ...
    public readonly struct Int3TweenPlugin : ITweenPlugin<int3>
    {
        ...
        {
            var startValue = TweenWorld.EntityManager.GetComponentData<TweenStartValue<int3>>(entity).value;
            var endValue = TweenWorld.EntityManager.GetComponentData<TweenEndValue<int3>>(entity).value;
