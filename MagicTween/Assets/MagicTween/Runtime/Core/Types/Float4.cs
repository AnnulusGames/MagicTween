...
[assembly: RegisterGenericComponentType(typeof(TweenPropertyAccessor<float4>))]
[assembly: RegisterGenericComponentType(typeof(TweenPropertyAccessorUnsafe<float4>))]
...
#pragma warning restore CS0414
    ...
    public readonly struct Float4TweenPlugin : ITweenPlugin<float4>
    {
        ...
        {
            var startValue = TweenWorld.EntityManager.GetComponentData<TweenStartValue<float4>>(entity).value;
            var endValue = TweenWorld.EntityManager.GetComponentData<TweenEndValue<float4>>(entity).value;
    ...
    public sealed partial class LambdaFloat4TweenTranslationSystem : LambdaTweenTranslationSystemBase<float4> { }
}