...
[assembly: RegisterGenericComponentType(typeof(TweenDelegates<double>))]
[assembly: RegisterGenericComponentType(typeof(TweenDelegatesNoAlloc<double>))]
...
#pragma warning restore CS0414
    ...
    public readonly struct DoubleTweenPlugin : ITweenPlugin<double>
    {
        ...
        [BurstCompile]
        public static double EvaluateCore(ref EntityManager entityManager, in Entity entity, float t, bool isRelative, bool isFrom)
        {
            var startValue = entityManager.GetComponentData<TweenStartValue<double>>(entity).value;
            var endValue = entityManager.GetComponentData<TweenEndValue<double>>(entity).value;
    ...
    public sealed partial class DoubleTweenDelegateTranslationSystem : TweenDelegateTranslationSystemBase<double> { }
}