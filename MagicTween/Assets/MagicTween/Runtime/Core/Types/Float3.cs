...
[assembly: RegisterGenericComponentType(typeof(TweenDelegates<float3>))]
[assembly: RegisterGenericComponentType(typeof(TweenDelegatesNoAlloc<float3>))]
...
#pragma warning restore CS0414
    ...
    public readonly struct Float3TweenPlugin : ITweenPlugin<float3>
    {
        ...
        public static void EvaluateCore(ref EntityManager entityManager, in Entity entity, float t, bool isRelative, bool isFrom, out float3 result)
        {
            ...
            var endValue = entityManager.GetComponentData<TweenEndValue<float3>>(entity).value;
    ...
    public sealed partial class Float3TweenDelegateTranslationSystem : TweenDelegateTranslationSystemBase<float3> { }
}