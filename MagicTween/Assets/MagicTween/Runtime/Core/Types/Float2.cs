...
[assembly: RegisterGenericComponentType(typeof(TweenDelegates<float2>))]
[assembly: RegisterGenericComponentType(typeof(TweenDelegatesNoAlloc<float2>))]
...
#pragma warning restore CS0414
    ...
    public readonly struct Float2TweenPlugin : ITweenPlugin<float2>
    {
        ...
        [BurstCompile]
        public static void EvaluateCore(ref EntityManager entityManager, in Entity entity, float t, bool isRelative, bool isFrom, out float2 result)
        {
            var startValue = entityManager.GetComponentData<TweenStartValue<float2>>(entity).value;
            var endValue = entityManager.GetComponentData<TweenEndValue<float2>>(entity).value;
    ...
    public sealed partial class Float2TweenDelegateTranslationSystem : TweenDelegateTranslationSystemBase<float2> { }
}