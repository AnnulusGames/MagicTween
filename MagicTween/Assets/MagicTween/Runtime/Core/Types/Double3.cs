...
[assembly: RegisterGenericComponentType(typeof(TweenDelegates<double3>))]
[assembly: RegisterGenericComponentType(typeof(TweenDelegatesNoAlloc<double3>))]
...
#pragma warning restore CS0414
    ...
    public readonly struct Double3TweenPlugin : ITweenPlugin<double3>
    {
        ...
        [BurstCompile]
        public static void EvaluateCore(ref EntityManager entityManager, in Entity entity, float t, bool isRelative, bool isFrom, out double3 result)
        {
            var startValue = entityManager.GetComponentData<TweenStartValue<double3>>(entity).value;
            var endValue = entityManager.GetComponentData<TweenEndValue<double3>>(entity).value;
    ...
    public sealed partial class Double3TweenDelegateTranslationSystem : TweenDelegateTranslationSystemBase<double3> { }
}