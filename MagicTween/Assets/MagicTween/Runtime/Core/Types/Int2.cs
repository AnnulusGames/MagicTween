...
namespace MagicTween.Core
{
    ...
    public readonly struct Int2TweenPlugin : ITweenPlugin<int2>
    {
        ...
        {
            var startValue = TweenWorld.EntityManager.GetComponentData<TweenStartValue<int2>>(entity).value;
            var endValue = TweenWorld.EntityManager.GetComponentData<TweenEndValue<int2>>(entity).value;
