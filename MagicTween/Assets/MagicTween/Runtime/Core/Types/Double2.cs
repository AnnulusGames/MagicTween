...
[assembly: RegisterGenericComponentType(typeof(TweenDelegates<double2>))]
[assembly: RegisterGenericComponentType(typeof(TweenDelegatesNoAlloc<double2>))]
...
#pragma warning restore CS0414
    ...
    public readonly struct Double2TweenPlugin : ITweenPlugin<double2>
    {
        ...
        [BurstCompile]
        public static void EvaluateCore(ref EntityManager entityManager, in Entity entity, float t, bool isRelative, bool isFrom, out double2 result)
        {
            var startValue = entityManager.GetComponentData<TweenStartValue<double2>>(entity).value;
            var endValue = entityManager.GetComponentData<TweenEndValue<double2>>(entity).value;
    ...
    public sealed partial class Double2TweenDelegateTranslationSystem : TweenDelegateTranslationSystemBase<double2> { }
}
